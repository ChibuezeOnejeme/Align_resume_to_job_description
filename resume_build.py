...
completion = client.chat.completions.create(
    ...
    messages=[
        ...
        {
            "role": "user",
            "content": "Build a custom resume, i mean reword it for this job posting here is the resume:" + resume + "  and here is the job description " + jobDescription
        },
...
output_file_name = f"resume_{timestamp}.docx"    
